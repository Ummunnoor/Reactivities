...
namespace application.Core
{
    public class MappingProfiles : Profile
    {
        public MappingProfiles()
        {
            ...
            .ForMember(d => d.Following, o => o.MapFrom(s => s.User.Followers.Any(x => x.FollowerId == currentUserId)));
            ...
            .ForMember(d => d.Following, o => o.MapFrom(s => s.Followers.Any(x => x.FollowerId == currentUserId)));

...
namespace API
{
    ...
    public class ProfilesController : BaseApiController
    {
        ...
        [HttpGet("{userId}")]
        public async Task<ActionResult<Result<UserProfile>>> GetProfile(string userId)
        {
        ...
        {
            return HandleResult(await Mediator.Send(new FollowToggle.Command { FolloweeUserId = userId }));
        }
